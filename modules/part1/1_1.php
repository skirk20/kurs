...
<p>Dzięki realizacji tego modułu poznasz system wartości rodziców. Będziesz w&nbspstanie określić
    ...
    wychowywane dzieci oraz skonfrontujesz je z&nbspwłasnymi przekonaniami oraz wartościami
    przyjętymi przez szkołę (np. w programie profilaktyczno-wychowawczym).
    Przygotujesz uczniów do analizowania własnych zachowań i&nbsppodejmowania decyzji
    z&nbspuwzględnieniem ich systemu wartości.</p>
    <div class = "back_next">
