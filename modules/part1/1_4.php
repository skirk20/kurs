...
<h2>Wiedza</h2>
<p>Zapewne znacznie łatwiej będzie pani Justynie zrozumieć uwagę nauczycielki po&nbspprzeczytaniu
    wiadomości nr 1. Magda odniosła się do&nbspkonkretnej wartości, na&nbspdodatek powszechnie
    uznanej za&nbspważną. Oczywiście nie mamy pewności, że&nbspmama Adriana zmieni swoją postawę,
    czyli uzna, że&nbsptak szeroko pojęta wolność jest w tej sytuacji mniej ważna od szacunku, jednak
    będzie musiała się nad tym zastanowić, dokonać wyboru.</p>
    <p>
        Magda pisząc wiadomość nr 2 odwołała się wyłącznie do&nbspprocedur. Mama Adriana, nie
rozumiejąc ich celu, może czuć potrzebę obrony swojego systemu wartości i&nbspjeszcze mocniej
bronić wolności wyboru swojego syna. A&nbspto już prosta droga do, zbędnego w&nbsptym przypadku,
konfliktu o wartości.
    </p>
    <p>
        Będąc wychowawcą, stajesz się liderem klasy. A&nbspta, podobnie jak inne organizacje
...
<h3>Co wtedy?</h3>
<p>Jako wychowawca ponosisz odpowiedzialność za&nbspklasę, za&nbsprealizację funkcji wychowawczej
    i&nbspopiekuńczej. Wyjaśnij rodzicom, które wartości z&nbspzaproponowanych staną się waszym
    drogowskazem a&nbspktóre nie. Odwołaj się&nbspdo swojego doświadczenia, literatury naukowej,
    badań.</p>
    <p>
        Jeśli sytuacja jest patowa i&nbsprodzice są wyznawcami skrajnie różnych wartości, najbezpieczniej
jest pozostać przy z&nbspgóry określonych wartościach określonych w&nbspprawie szkolnym
i&nbspoświatowym.
    </p>
    <div class = "back_next">
