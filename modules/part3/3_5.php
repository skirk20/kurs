...
<article class="modules-content">
    ...
    <p>
        ...
        <b>Czas:</b> 45 minut (+ ewentualne rozszerzenie o dodatkowe 45 minut)
    </p>
    <h3>Cel:</h3>
...
panujących na lekcji (wywieś kontrakt).
    ...
    <h3>Faza realizacyjna [25 minut]</h3>
    <ol class="a1_5-list">
    <li style="list-style: '2. '">
        
    Poproś uczniów o&nbsppołączenie się w pary, ewentualnie w&nbsptrzyosobowe grupy. Wręcz
przykłady informacji zwrotnych z&nbspzałącznika nr 1: otrzymaną od&nbspnauczyciela za efekt pracy (wypracowanie), za proces (prezentacja projektu), udzieloną przez
...
mocne i&nbspsłabe strony każdej z informacji zwrotnej, czy uzyskali dzięki temu wiedzę potrzebną do lepszego wykonania tego samego zadania.
...
<p>    
Uczniowie powinni dojść do wniosku, że&nbspinformacje zwrotne zawierające konkretne
...
rodzice nauczyli się formułować informację zwrotną. Poproś o&nbspzgodę uczniów.
    ...
    Wyjaśnij, że chciałbyś zebrać te opisy i rozdać je rodzicom na zebraniu - po to, aby rodzice nauczyli się formułować informację zwrotną. Poproś o zgodę uczniów.
    </li>
    </ol>
    <p>
jeśli uważasz, że to zadanie może być dla uczniów lub Ciebie niekomfortowe, to możesz:
</p>
<ul>
    <li>zachęcić do rozmowy: W jakich sytuacjach domowych chcielibyście otrzymywać informacje zwrotne? Dlaczego w takich?</li>
    <li>wykorzystać propozycję rozszerzenia scenariusza przedstawioną poniżej.
</li>
</ul>
...
tym, że to odpowiedni moment.
    ...
    <li style="list-style: '5. '">
    Na koniec: zmierz wieże, zachęć do wzajemnego docenienia się (zwłaszcza jeśli
uczestnicy realizowali moduł 2).
    </li>
    <li style="list-style: '6. '">
    Zainicjuj dyskusję:
    <ul>
        <li>
        Jak wam było w tej zabawie? Co czuliście? Jak zmieniały się wasze nastroje?
        </li>
        <li>
        Jak postępowała wasza współpraca?
        </li>
        <li>
        Czego się dowiedzieliście o sobie?
        </li>
        <li>
        Czego dowiedzieliście się o innych?
        </li>
        <li>
...
najmniej dwie informacje zwrotne.
    ...
    <li style="list-style: '8. '">
    Podsumuj wskazując, dlaczego warto dokonywać podsumowań.
    </li>
    <li style="list-style: '9. '">
