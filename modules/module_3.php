...
<section class="left-bar">
    ...
    <h3>
        ...
        <h3><a href="../part3/3_1-main.php" class="module-choice" style="color: #028388;"> Omówienie, czyli świętowanie sukcesów i&nbspanalizowanie porażek</a></h3>
        <ul>    
        <li><a href="3_1.php" class="button-choice btn">efekt</a></li>
            <li><a href="3_2.php" class="button-choice btn">studium przypadku</a></li>
            <li><a href="3_3.php" class="button-choice btn">refleksja</a></li>
            <li><a href="3_4.php" class="button-choice btn">wiedza</a></li>
            <li><a href="3_5.php" class="button-choice btn">Scenariusze zajęć</a></li>
            <li><a href="3_6.php" class="button-choice btn">Inspiratorium</a></li>
            <li><a href="3_7.php" class="button-choice btn">dowiedz się więcej</a></li>
            </ul>
